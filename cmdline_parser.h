...
class CmdLineParser {
public:
    CmdLineParser(const std::string& description = "") : description_(description) {}

    void add_option(const std::string& short_opt, const std::string& long_opt,
                   const std::string& help, bool has_value = false,
    ...
    void add_option_with_optional_value(const std::string& short_opt, const std::string& long_opt,
