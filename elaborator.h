...
struct PropertyValue {
    ...
    PropertyValue() : type(STRING), string_val(""), int_val(0), bool_val(false) {}
    PropertyValue(const std::string& s) : type(STRING), string_val(s) {}
    PropertyValue(int64_t i) : type(INTEGER), int_val(i) {}
    PropertyValue(bool b) : type(BOOLEAN), bool_val(b) {}
};
...
private:
    ...
    void collect_component_definitions(
        SystemRDLParser::RootContext* ast_root
    );

    void collect_component_definitions_from_body(
        SystemRDLParser::Component_bodyContext* body_ctx
    );

    void register_component_definition(
    ...
    PropertyValue evaluate_property_value(
    ...
    PropertyValue evaluate_expression(
        SystemRDLParser::ExprContext* expr_ctx
    );

    PropertyValue evaluate_expression_primary(
        SystemRDLParser::Expr_primaryContext* primary_ctx
    );

    int64_t evaluate_integer_expression_enhanced(
        SystemRDLParser::ExprContext* expr_ctx
    );
    ...
    void collect_enum_and_struct_definitions(
        SystemRDLParser::RootContext* ast_root
    );
    ...
    void register_enum_definition(
        SystemRDLParser::Enum_defContext* enum_def
    );

    void register_struct_definition(
    ...
    std::unique_ptr<ElaboratedNode> create_elaborated_node(
    ...
    Address evaluate_address_expression(
        SystemRDLParser::ExprContext* expr_ctx
    );

    size_t evaluate_integer_expression(
        SystemRDLParser::ExprContext* expr_ctx
    );
